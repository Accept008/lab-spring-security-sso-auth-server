...
/**
 * Simple {@code RestErrorResponseConverter} implementation that creates a new Map instance based on the specified RestError
 ...
 *     <tr>
 *         <td>status</td>
 *         <td>restError.{@link RestErrorResponse#getStatus() getStatus()}.{@link org.springframework.http.HttpStatus#value() value()}</td>
 *         <td></td>
 *     </tr>
 *     <tr>
 *         <td>code</td>
 *         <td>restError.{@link RestErrorResponse#getErrCode() getErrCode()}</td>
 *         <td>Only set if {@code code > 0}</td>
 *     </tr>
 *     <tr>
 *         <td>message</td>
 *         <td>restError.{@link RestErrorResponse#getErrMsg() getErrMsg()}</td>
 *         <td>Only set if {@code message != null}</td>
 *     </tr>
 *     <tr>
 *         <td>developerMessage</td>
 *         <td>restError.{@link RestErrorResponse#getDevMsg() getDevMsg()}</td>
 *         <td>Only set if {@code developerMessage != null}</td>
 *     </tr>
 *     <tr>
 *         <td>moreInfoUrl</td>
 *         <td>restError.{@link RestErrorResponse#getMoreInfoUrl() getMoreInfoUrl()}</td>
 *         <td>Only set if {@code moreInfoUrl != null}</td>
 *     </tr>
 *     <tr>
 *         <td>requestId</td>
 *         <td>restError.{@link RestErrorResponse#getRequestId()} getRequestId()}</td>
 ...
 *
 */
public class MapRestErrorResponseConverter implements RestErrorResponseConverter<Map> {
    ...
    @Override
    public Map convert(RestErrorResponse re) {
